...
public class ServiceRequestDashboardTests
{
    ...
    public ServiceRequestDashboardTests()
    {
    ...
    [Fact]
    public async Task GetStats_GroupsRequestsByStatus_ReturnsOk()
    {
        // Arrange
        var stats = new
        {
    ...
    [Fact]
    public async Task GetStats_CalculatesMonthlyRevenue_ReturnsOk()
    {
        // Arrange
        var stats = new
        {
    ...
    [Fact]
    public async Task GetStats_CalculatesTechnicianWorkload_ReturnsOk()
    {
        // Arrange
        var stats = new
        {
    ...
    [Fact]
    public async Task GetStats_CalculatesAverageResolutionTime_ReturnsOk()
    {
        // Arrange
        var stats = new
        {
